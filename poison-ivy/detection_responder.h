...
#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_POISON_IVY_DETECTION_RESPONDER_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_POISON_IVY_DETECTION_RESPONDER_H_
...
void RespondToDetection(tflite::ErrorReporter* error_reporter,
                        int8_t poison_ivy_score, int8_t no_poison_ivy_score);

#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_POISON_IVY_DETECTION_RESPONDER_H_
