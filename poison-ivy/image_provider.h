...
#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_POISON_IVY_IMAGE_PROVIDER_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_POISON_IVY_IMAGE_PROVIDER_H_
...
#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_POISON_IVY_IMAGE_PROVIDER_H_
